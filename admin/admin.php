          ...
          <div id="barang" class="tab-pane fade">
            ...
            <div class="container">
              ...
              <ul class="nav nav-pills" style="margin-left: 15vw;">
                ...
                <li class="item-kategori"><a data-toggle="tab" href="#tabel-batik">Batik</a></li>
              </ul>
            </div>
            ...
            <div class="tab-content">
              ...
              <div id="tabel-batik" class="tab-pane fade">
                <div class="row">
                  <div class="col-xs-11 col-offset-xs-1">
                    <table class="table table-condensed" style="width:80vw">
                      <thead>
          ...
          <div id="transaksi" class="tab-pane fade">
            <div class="row">
              <div class="col-xs-11 col-offset-xs-1">
                <br>
                <center>
                  <h3><strong> Batang Jumlah Transaksi Tiap Bulan</strong></h3>
                  ...
                  <tbody>
                    ...
                    if ($jumlah == 0) {
                      ...
                      while ($arrayBarang = mysqli_fetch_array($queryBarang)) {
                        $queryUser = mysqli_query($conn, "SELECT namaUser, alamat FROM tabel_user");
  ...
  <script>
    ...
    var myChart = new Chart(ctx, {
      ...
      data: {
        ...
        datasets: [{
          label: 'Jumlah Transaksi Berdasarkan Bulan',
          data: [
            <?php
            $jumlah_januari = mysqli_query($conn, "SELECT SUM(total) as jumlah FROM `tabel_transaksi` WHERE MONTH(tanggal) = 1");
            $result = mysqli_fetch_array($jumlah_januari, MYSQLI_NUM);
            echo $result[0];
            ?>,
            <?php
            $jumlah_februari = mysqli_query($conn, "SELECT SUM(total) as jumlah FROM `tabel_transaksi` WHERE MONTH(tanggal) = 2");
            $result = mysqli_fetch_array($jumlah_februari, MYSQLI_NUM);
            echo $result[0];
            ?>,
            <?php
            $jumlah_maret = mysqli_query($conn, "SELECT SUM(total) as jumlah FROM `tabel_transaksi` WHERE MONTH(tanggal) = 3");
            $result = mysqli_fetch_array($jumlah_maret, MYSQLI_NUM);
            echo $result[0];
            ?>,
            <?php
            $jumlah_april = mysqli_query($conn, "SELECT SUM(total) as jumlah FROM `tabel_transaksi` WHERE MONTH(tanggal) = 4");
            $result = mysqli_fetch_array($jumlah_april, MYSQLI_NUM);
            echo $result[0];
            ?>,
            <?php
            $jumlah_mei = mysqli_query($conn, "SELECT SUM(total) as jumlah FROM `tabel_transaksi` WHERE MONTH(tanggal) = 5");
            $result = mysqli_fetch_array($jumlah_mei, MYSQLI_NUM);
            echo $result[0];
            ?>,
            <?php
            $jumlah_juni = mysqli_query($conn, "SELECT SUM(total) as jumlah FROM `tabel_transaksi` WHERE MONTH(tanggal) = 6");
            $result = mysqli_fetch_array($jumlah_juni, MYSQLI_NUM);
            echo $result[0];
            ?>,
            <?php
            $jumlah_juli = mysqli_query($conn, "SELECT SUM(total) as jumlah FROM `tabel_transaksi` WHERE MONTH(tanggal) = 7");
            $result = mysqli_fetch_array($jumlah_juli, MYSQLI_NUM);
            echo $result[0];;
            ?>,
            <?php
            $jumlah_agustus = mysqli_query($conn, "SELECT SUM(total) as jumlah FROM `tabel_transaksi` WHERE MONTH(tanggal) = 8");
            $result = mysqli_fetch_array($jumlah_agustus, MYSQLI_NUM);
            echo $result[0];
            ?>,
            <?php
            $jumlah_september = mysqli_query($conn, "SELECT SUM(total) as jumlah FROM `tabel_transaksi` WHERE MONTH(tanggal) = 9");
            $result = mysqli_fetch_array($jumlah_september, MYSQLI_NUM);
            echo $result[0];
            ?>,
            <?php
            $jumlah_oktober = mysqli_query($conn, "SELECT SUM(total) as jumlah FROM `tabel_transaksi` WHERE MONTH(tanggal) = 10");
            $result = mysqli_fetch_array($jumlah_oktober, MYSQLI_NUM);
            echo $result[0];
            ?>,
            <?php
            $jumlah_november = mysqli_query($conn, "SELECT SUM(total) as jumlah FROM `tabel_transaksi` WHERE MONTH(tanggal) = 11");
            $result = mysqli_fetch_array($jumlah_november, MYSQLI_NUM);
            echo $result[0];
            ?>,
            <?php
            $jumlah_desember = mysqli_query($conn, "SELECT SUM(total) as jumlah FROM `tabel_transaksi` WHERE MONTH(tanggal) = 12");
            $result = mysqli_fetch_array($jumlah_desember, MYSQLI_NUM);
            echo $result[0];
            ?>
          ],
          backgroundColor: [
