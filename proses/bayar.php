...
$queryInsert = mysqli_query($conn, "INSERT INTO tabel_transaksi (idUser, daftarBarang, tanggal, total, status) VALUES ('$idUser', '$barang', '$tanggal', '$total', '$status')");
...
if ($query) {
  echo '
      <script>
      alert("Terima Kasih sudah Berbelanja, Silahkan Tranfer ke Rekening Mandiri 140-0-0-165473-4 an. Tari Damayanti. Barang anda akan segera kami kirim setelah pembayaran dilakukan. Semoga anda nyaman dengan layanan kami.!");
